      ...
      <div className="container-custom">
        <div className="grid items-center gap-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-12">
            ...
            <div className="premium-panel relative overflow-hidden p-4 sm:p-5">
              <div className="relative h-[320px] overflow-hidden rounded-[24px] sm:h-[420px]">
                ...
                <div className="absolute inset-x-5 bottom-5 rounded-[24px] border border-white/10 bg-black/35 p-5 backdrop-blur-sm">
                  <h3 className="text-2xl font-black uppercase tracking-[0.08em] text-white">ME-KA INSAAT</h3>
                  <p className="mt-3 text-sm leading-7 text-stone-300">Planlama, saha koordinasyonu ve teslim kalitesini ayni cizgide tutan operasyon modeliyle calisiyoruz.</p>
                </div>
              </div>
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.6 }} className="order-1 lg:order-2">
            ...
            <p className="mt-6 text-sm leading-8 text-stone-300 md:text-base">ME-KA Insaat; Erzurum merkezli operasyon yapisiyla yol yapimi, beton agrega, tunel, dere islahi, tas isleri, bordur-kaldirim ve buyuk altyapi kalemlerinde sahaya uygun cozumler uretir. Yerel saha bilgisiyle ilerler, uygulama ritmini arazi ve iklim kosullarina gore kurar.</p>
            <p className="mt-5 text-sm leading-8 text-stone-300 md:text-base">Yakutiye merkezli iletisim yapimiz sayesinde kesif, teklif, saha kurulumu ve uygulama takibini ayni hat uzerinden yuruturuz. Malzeme, ekipman ve ekip koordinasyonunu teslim hedefiyle ayni cizgide tutariz.</p>
