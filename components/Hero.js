...
const highlights = [
  ...
  {
    title: 'Beton, hafriyat ve agrega planlamasi',
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'Demir, ihale ve saha koordinasyonu',
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function CounterCard({ end, suffix, label, delay = 0 }) {
  ...
  return (
    <motion.div
      ...
      className="rounded-2xl border border-white/10 bg-black/35 px-4 py-5 backdrop-blur-md"
    >
  ...
  return (
    <section className="relative isolate min-h-screen overflow-hidden bg-primary pt-24">
      ...
      <div className="relative z-10">
        <div className="container-custom flex min-h-[calc(100vh-96px)] items-end pb-8 md:pb-10">
          <div className="w-full">
            <div className="grid gap-3 xl:grid-cols-[220px_minmax(0,1fr)_220px]">
              ...
              >
                <Link
                  href="/projects"
                  className="inline-flex min-h-[84px] items-center justify-center rounded-2xl border border-white/10 bg-black/35 px-5 py-4 text-center text-sm font-black uppercase tracking-[0.14em] text-white backdrop-blur-md transition hover:border-accent/50 hover:text-accent"
                >
                  Projeleri Incele
                </Link>
                <Link
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                  {highlights.map((item, index) => (
                    <motion.div
                      ...
                      className="flex items-center gap-3 rounded-2xl border border-white/10 bg-black/35 px-4 py-4 text-sm font-medium text-stone-100 backdrop-blur-md"
                    >
              ...
              >
                <Link
                  href="/contact"
                  className="inline-flex min-h-[84px] items-center justify-center rounded-2xl bg-accent px-5 py-4 text-center text-sm font-black uppercase tracking-[0.14em] text-slate-950 shadow-[0_0_24px_rgba(215,162,61,0.28)] transition hover:-translate-y-0.5"
                >
                  Teklif Al
                </Link>
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex min-h-[84px] items-center justify-center rounded-2xl bg-[#25D366] px-5 py-4 text-center text-sm font-black uppercase tracking-[0.14em] text-slate-950 transition hover:-translate-y-0.5 hover:brightness-110"
                >
                  WhatsApp'tan Yaz
                </a>
              </motion.div>
