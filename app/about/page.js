...
const corporateNotes = [
  ...
  'Erzurum odakli hizmet diliyle daha net arama ve kurumsal gorunurluk',
]
  ...
  return (
    <main className="pt-20">
      <section className="relative min-h-[52vh] overflow-hidden flex items-center">
        <Image src="/gallery/15.jpg" alt="ME-KA Insaat operasyon alani" fill sizes="100vw" className="object-cover" />
        ...
        <div className="container-custom relative z-10 py-16">
          <ScrollReveal>
            ...
            <p className="mt-5 max-w-3xl text-sm leading-8 text-stone-300 md:text-lg">ME-KA Insaat; Erzurum ve Yakutiye merkezli yapisiyla yol yapimi, beton agrega, tunel, dere islahi, tas isleri, bordur-kaldirim ve buyuk altyapi projelerinde planli uygulama, net koordinasyon ve kontrollu teslim anlayisiyla calisir.</p>
          </ScrollReveal>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] gap-12 items-center">
            <ScrollReveal direction="left">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">Erzurum ve cevresindeki islerde iklim, arazi yapisi ve lojistik kosullar sonuca dogrudan etki eder. ME-KA Insaat, yerel saha tecrubesi sayesinde hizli karar alan ama kontrolu kaybetmeyen bir uygulama modeli kurar. Kurumsal iletisim dili, sahadaki gercek uygulama refleksiyle desteklenir.</p>
            ...
            <ScrollReveal direction="right">
              <div className="relative h-[340px] md:h-[440px] overflow-hidden rounded-[28px] shadow-xl">
                <Image src="/gallery/13.jpg" alt="ME-KA Insaat saha calismasi" fill sizes="(max-width: 1024px) 100vw, 45vw" className="object-cover" />
            ...
            <ScrollReveal delay={0.08}>
              <div className="premium-panel h-full p-8">
                ...
                <div className="mt-6 rounded-[24px] overflow-hidden border border-white/10">
                  <iframe
                    title="ME-KA Insaat Erzurum Harita"
