export const siteConfig = {
  ...
  title: 'ME-KA Insaat Erzurum | Yol, Beton, Agrega, Tunel ve Altyapi Cozumleri',
  description:
    'ME-KA Insaat; Erzurum ve Yakutiye bolgesinde yol yapimi, beton agrega, tunel, dere islahi, tas isleri, bordur-kaldirim ve buyuk altyapi uygulamalari sunar.',
  locality: 'Yakutiye',
  region: 'Erzurum',
  countryCode: 'TR',
  ...
  serviceAreas: ['Yakutiye', 'Erzurum Merkez', 'Erzurum geneli'],
  businessCategories: [
    'Yol yapimi',
    'Beton agrega',
    'Tunel isleri',
    'Dere islahi',
    'Tas isleri',
    'Beton bordur ve kaldirim',
    'Buyuk altyapi projeleri',
  ],
  seoKeywords: [
    'Erzurum beton',
    'Erzurum hafriyat',
